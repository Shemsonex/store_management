...
<script>
      ...
      // console.log(token);
              ...
              data.map(dat =>{
                ...
                // if(dat.category == 1){
                  document.getElementById('items').innerHTML += `
                    <option value="`+dat.id+`">`+dat.product_name+`</option>`;
                // }
        ...
        .catch(error => console.error('Error:', error));
           ...
           fetch('https://hardware.cyclic.app/api/stock/getAllStock', {
              ...
              .then(data => {console.log(data)
                    data.stock.map(dat =>{
                      console.log(dat);
                        document.getElementById('added_items').innerHTML += ` <tr>
                        <td><a href="./construction-details.php?aid=`+dat.id+`"><span class="badge bg-label-success">`+dat.product.product_name+`</span></td></a>
                        <td><a href="./construction-details.php?aid=`+dat.id+`">`+dat.quantity+`</td></a>
                        <td><a href="./construction-details.php?aid=`+dat.id+`">`+dat.product.price+`</td></a>                   
                        <td>
                          <div class="dropdown">
        ...
        function sale(){
          ...
          const tosend = JSON.stringify(tosen)          
          // console.log(tosend)
          fetch('https://hardware.cyclic.app/api/stock/dedact', {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json',
              'Accept': '*',
            ...
            .then(response => response.json())
            .then(data => {console.log(data)
              document.getElementById('msg').innerHTML=`<span><font="green">Added !</font></span>`;
              function timing() {
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <div class="container">
                    <select class="" name="items" id="items"></select>
                    <input class="" type="text" name="qty" id="qty" >
                    <input class="btn btn-primary" type="submit" value="Ok" onclick="sale()">
                    <span id="msg"></span>
                    <hr>
                  </div>
                  <div class="table-responsive text-nowrap">
                    <div class="container">
                      <table class="table">
                        ...
                        <tbody class="table-border-bottom-0" id="added_items">
