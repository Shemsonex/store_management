                      ...
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="lastName" id="idNumber" value="1234567891234567891" />
                          </div>
                          
                          <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Phone Number</label>
                            <input class="form-control" type="text" name="" id="Number" value="0782 848 625" />
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              ...
                              id="email"
                              name="email"
                              value="thierryngoga@gmail.com"
                              placeholder="thierryngoga@gmail.com"
                            />
                          </div>
                        ...
                        <a type="button" href="account-details.php" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                      </form>
                    </div>
                    <!-- /Account -->
