<?php include('./layout/header.php'); ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> List of All Clients </h4>
                      ...
                      <div class="mt-3">
                        ...
                        >
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              <div class="col mb-3">
                                <label for="nameBasic" class="form-label">District</label>
                            ...
                            <div class="row">
                              <div class="col mb-3">
                                <label for="nameBasic" class="form-label">Sector</label>
                            ...
                            <div class="row">
                              <div class="col mb-3">
                                <label for="nameBasic" class="form-label">Cell</label>
                            ...
                            <div class="row">
                              <div class="col mb-3">
                                <label for="nameBasic" class="form-label">Village</label>
                            ...
                            <div class="row">
                              <div class="col mb-3">
                                <div class="input-group">
                                  <label class="input-group-text" for="inputGroupFile01">Upload Client Photo</label>
